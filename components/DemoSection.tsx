...
export function DemoSection() {
  return (
    ...
    >
      ...
      <div className="z-10 max-w-4xl mx-auto px-6 relative">
        ...
        <div className="relative bg-slate-900 rounded-3xl p-8 md:p-12 shadow-2xl shadow-slate-900/50 border border-slate-800 overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-transparent pointer-events-none" />
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-600/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 pointer-events-none group-hover:bg-emerald-600/20 transition-colors duration-700" />

          <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-12 z-10">
            <div className="flex-shrink-0 relative">
              <div className="absolute inset-0 bg-emerald-500 rounded-full blur-xl opacity-20 animate-pulse" />
              <button
                type="button"
                className="relative w-20 h-20 md:w-24 md:h-24 rounded-full bg-white text-slate-900 flex items-center justify-center hover:scale-105 transition-all duration-300 cursor-pointer shadow-xl shadow-black/20 group/btn border-4 border-slate-900/10"
                aria-label="Play agent introduction"
              >
                <Icon
                  icon="solar:play-bold"
                  className="text-3xl md:text-4xl ml-1 text-slate-900 group-hover/btn:text-emerald-600 transition-colors"
                  width={32}
                />
              </button>
            </div>
            ...
            <div className="flex-grow w-full text-center md:text-left">
              <div className="flex flex-col md:flex-row justify-between items-center mb-6 md:mb-4 gap-3">
                <div>
              ...
              <div
                className="flex items-end justify-center md:justify-start gap-1.5 h-16 md:h-12 opacity-90 [&>*]:animate-sound"
                aria-hidden
              >
                {[
