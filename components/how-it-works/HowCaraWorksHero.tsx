...
import { HOW_CARA_WORKS_HERO } from "@/lib/how-cara-works-copy";
import {
...
export function HowCaraWorksHero() {
  return (
      ...
      <div className={HERO_PAGE_FRAME_INNER_CLASS}>
        <div className={HERO_NICHE_CARD_CLASS}>
          ...
          >
            ...
            <rect width="100%" height="100%" fill="url(#how-cara-grid-pattern)" />
          </svg>
          ...
          <div className={HERO_NICHE_CARD_INNER_CLASS}>
            ...
            <div className={HERO_NICHE_CONTENT_CLASS}>
              ...
              <p className={HERO_NICHE_INTRO_CLASS}>{HOW_CARA_WORKS_HERO.intro}</p>
              ...
              <div className={HERO_NICHE_CTA_ROW_CLASS}>
                ...
                >
                  {HOW_CARA_WORKS_HERO.primaryCta}
                </Link>
                <Link
