...
import { YOUR_DASHBOARD_HERO } from "@/lib/your-dashboard-copy";
import {
...
export function YourDashboardHero() {
  return (
      ...
      <div className={HERO_PAGE_FRAME_INNER_CLASS}>
        <div className={HERO_NICHE_CARD_CLASS}>
          ...
          >
            <defs>
              <pattern
                id="your-dashboard-grid-pattern"
                x="50%"
                y="0"
                width="256"
                height="256"
            ...
            <rect
              width="100%"
              height="100%"
              fill="url(#your-dashboard-grid-pattern)"
            />
          </svg>
            ...
            <div className={HERO_NICHE_CONTENT_CLASS}>
              <div className={HERO_NICHE_EYEBROW_CLASS}>
                ...
                <p className="text-[11px] font-medium uppercase tracking-[0.18em] text-slate-500">
                  {YOUR_DASHBOARD_HERO.eyebrow}
                </p>
              </div>

              <h1 id="your-dashboard-heading" className={HERO_NICHE_HEADING_CLASS}>
                <span className="block text-slate-900">
                  {YOUR_DASHBOARD_HERO.titleDark}
                </span>
                <span className={HERO_NICHE_TITLE_GRADIENT_CLASS}>
                  {YOUR_DASHBOARD_HERO.titleGradient}
                </span>
              </h1>

              <p className={HERO_NICHE_INTRO_CLASS}>{YOUR_DASHBOARD_HERO.intro}</p>
              ...
              <div className={HERO_NICHE_CTA_ROW_CLASS}>
                ...
                >
                  {YOUR_DASHBOARD_HERO.primaryCta}
                </Link>
                <Link
                  href="#cara-writes-it-down"
                ...
                >
                  {YOUR_DASHBOARD_HERO.secondaryCta}
